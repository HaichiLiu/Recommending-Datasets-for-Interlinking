...
public class MyIRStatisticsImpl implements IRStatistics {
	  ...
	  public MyIRStatisticsImpl(double precision, double recall, double fallOut, double ndcg, double reach) {
