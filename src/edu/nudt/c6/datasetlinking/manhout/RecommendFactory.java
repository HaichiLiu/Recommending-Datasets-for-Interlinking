...
public final class RecommendFactory {
    ...
    public enum SIMILARITY {
        ...
        DATASET_VOCABULARY_COSINE, DATASET_CLASS_COSINE, DATASET_PROPERTY_COSINE, DATASET_MAX_VOCABULARY_COSINE, MATERIALIZED_CITYBLOCK, DATASET_LINKING_ITEM_SIMILARITY, DATASET_LINKING_WEIGHTSUM_ITEM_SIMILARITY, PEARSON_WEIGHTED, EUCLIDEAN_WEIGHTED, DATASET_PPROPERTY_COSINE_SUBJECTS, DATASET_PPROPERTY_COSINE_TRIPLES, 
    }
    ...
    public static ItemSimilarity itemSimilarity(SIMILARITY type, DataModel m) throws TasteException, FileNotFoundException, IOException, ClassNotFoundException {
        switch (type) {
        case CITYBLOCK:
            return new CityBlockSimilarity(m);
        case EUCLIDEAN:
        ...
        case LOGLIKELIHOOD:
            return new LogLikelihoodSimilarity(m);
        case DATASET_MAX_VOCABULARY_COSINE:
			return new DatasetMaxVocabularyItemSimilarity(m);
        case MATERIALIZED_CITYBLOCK:
			return new MaterializedCityBlockItemSimilarity(m);
        case DATASET_LINKING_ITEM_SIMILARITY:
			return new DatasetLinkingItemSimilarity(m);
        case DATASET_LINKING_WEIGHTSUM_ITEM_SIMILARITY:
			return new DatasetLinkingWeightSumItemSimilarity(m);		
        default:
            return new EuclideanDistanceSimilarity(m);
        }
    }
    ...
    public enum RECOMMENDER {
        ITEM, USER, SVD, LINKDOCUMENT, CollaborativeRanking,
        Random, ItemAverage, ItemUserAverage //baseline推荐器       
    }
